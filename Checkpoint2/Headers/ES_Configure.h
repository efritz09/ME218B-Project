...
#define SERV_0_HEADER "Check2.h"
// the name of the Init function
#define SERV_0_INIT InitCheck2
// the name of the run function
#define SERV_0_RUN RunCheck2
...
// the name of the Init function
#define SERV_1_INIT InitButton
// the name of the run function
#define SERV_1_RUN RunButton
// How big should this services Queue be?
...
#define TIMER0_RESP_FUNC PostCheck2
#define TIMER1_RESP_FUNC PostCheck2
...
#define STRAIGHTAWAY_TIMER 0
#define TURN_TIMER 1
#define DebounceTimerNumber 2
