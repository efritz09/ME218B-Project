...
#define SERV_0_HEADER "Master.h"
// the name of the Init function
#define SERV_0_INIT InitMaster
// the name of the run function
#define SERV_0_RUN RunMaster
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "Drive.h"
// the name of the Init function
#define SERV_1_INIT InitDrive
// the name of the run function
#define SERV_1_RUN RunDrive
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "PWM.h"
// the name of the Init function
#define SERV_2_INIT InitPWM
// the name of the run function
#define SERV_2_RUN RunPWM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "Drive.h"
// the name of the Init function
#define SERV_3_INIT InitDrive
// the name of the run function
#define SERV_3_RUN RunDrive
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                ES_TIMEOUT, 			/* signals that the timer has expired */
								...
								EV_DRSNewRead,
								EV_DRSNewQuery,
                InShootingDecisionZone,
                InObstacleDecisionZone,
                CautionFlagDropped,
								FlagDropped,
								NextPointCalculated,
								PathGenerated,
                AtNextPoint,
								...
								EmergencyStop,
								SpeedChangePort,
								SpeedChangeStarboard,
								AtRatio,
								OffRatio,
								ToDriving,
								ToShooting,
								ToObstacle,
								//THESE ARE ONLY FOR CHECKPOINT3
								Waypoint_BR,
								Waypoint_TR,
								Waypoint_TL,
								Waypoint_BL,
								Waypoint_S,
								Waypoint_O} ES_EventTyp_t ;
...
#define TIMER0_RESP_FUNC PostMaster
#define TIMER1_RESP_FUNC PostMaster
#define TIMER2_RESP_FUNC PostMaster
#define TIMER3_RESP_FUNC PostMaster
#define TIMER4_RESP_FUNC PostMaster
#define TIMER5_RESP_FUNC PostMaster
#define TIMER6_RESP_FUNC PostMaster
#define TIMER7_RESP_FUNC PostMaster
#define TIMER8_RESP_FUNC PostMaster
#define TIMER9_RESP_FUNC PostMaster
#define TIMER10_RESP_FUNC PostMaster
#define TIMER11_RESP_FUNC PostMaster
...
#define ROTATE_TIMER 2
#define LOAD_BALL_TIMER 3
#define FIRE_BALL_TIMER 4
#define OBS_TIMER 5
#define OFF_TAPE_TIMER 6
#define BACK_TO_COURSE_TIMER 7
#define BALL_SHOOTER_TIMER 8
#define CHECK_TIMER 9
#define NITRO_TIMER 10
#define GIVE_UP_TIMER 11 //currently not used
#define numTimers 12
